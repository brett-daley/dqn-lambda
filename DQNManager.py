...
class DQNManager:
	def __init__(self, cfg_parser, n_teacher_dqns, n_actions, game_mgr, sess):
	...
	def update_game(self, game, timestep=9999999, is_test_mode=False, epsilon_forced=None):
		...
		cur_agt_action, cur_agt_qvalues = cur_dqn.get_action(epsilon=epsilon, agt=cur_agt, timestep=timestep, input_obs=cur_joint_obs[cur_agt.i], test_mode=is_test_mode, i_game=game.i_game)
